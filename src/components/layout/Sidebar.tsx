    ...
    <aside className={`sidebar ${isOpen ? 'mobile-open' : ''}`}>
      ...
      <div className="sidebar-footer">
        <div className="footer-logo">
          <img src="https://tronnus.com/wp-content/uploads/2026/01/tronnus-png-001.png" alt="TRONNUS" style={{ width: '120px', filter: 'brightness(0) invert(1) drop-shadow(0 4px 12px rgba(101, 131, 154, 0.6))', opacity: 0.9 }} />
        </div>
      </div>
    </aside>
  );
